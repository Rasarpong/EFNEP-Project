import excel "C:\Users\Kwabena Sarpong\OneDrive\Graduate School\EFNEP RESEARCH\EFNEP DATA\colorado\Colorado recalls_FPC_Biometrics.xlsx", sheet("Sheet1") firstrow
...
replace diabeties_pre_dummy =1 if (Total_Fiber_entry>=25 & Food_Energy_entry<=2300 & Carbohydrates_entry<=358 & pre_q07>=4 & pre_q09>=4)
...
replace diabeties_post_dummy =1 if (Total_Fiber_exit>=25 & Food_Energy_exit<=2300 & Carbohydrates_exit<=358 & post_q07>=4 & post_q09>=4)
