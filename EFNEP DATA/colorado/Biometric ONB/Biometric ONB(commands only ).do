import excel "C:\Users\richie\OneDrive\Graduate School\EFNEP RESEARCH\EFNEP DATA\colorado\Colorado ESBA Biometric Data.xlsx", sheet("Sheet1") firstrow clear
**********************************************************
...
*********************************************************
gen T1T2BP=.
replace T1T2BP = 1 if (T2SBP<T1SBP & T2DBP<=T1DBP)
replace T1T2BP = 1 if (T2SBP<=T1SBP & T2DBP<T1DBP)
...
tab T1T4BP, missing
*********************************************************
rename Vegetables Veg

rename Total_Fat Fat

rename Total_Fiber Fiber
